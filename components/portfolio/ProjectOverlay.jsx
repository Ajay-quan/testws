        ...
        >
          ...
          >
            ...
            <style>{`
              ...
              html[data-theme='dark'] .case-study-panel{--case-bg:#17191c;--case-header:rgba(23,25,28,.92);--case-text:#eeeae4;--case-heading:#faf8f4;--case-muted:#aaa7a2;--case-accent:#d4a85e;--case-line:rgba(224,226,229,.22);--case-soft:rgba(212,168,94,.065)}
              html[data-theme='dark'] [data-testid='project-overlay']{background:rgba(8,9,10,.8)!important}
              ...
              html[data-theme='dark'] .case-study-tone{background:linear-gradient(180deg,rgba(17,18,20,.03) 42%,rgba(17,18,20,.84) 100%),linear-gradient(125deg,color-mix(in srgb,var(--project-accent) 9%,transparent),transparent 45%)}
