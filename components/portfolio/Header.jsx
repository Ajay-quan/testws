    ...
    <header data-testid="site-header" className={`surface-accent hairline-b simple-header ${scrollPct > 0 ? 'is-scrolled' : ''}`}>
      ...
      <style>{`
        ...
        .simple-nav a:hover,.simple-nav a[aria-current] {
          ...
          border-color:rgba(255,255,255,.72); box-shadow:0 7px 18px rgba(68,53,36,.07),inset 0 1.5px 0 rgba(255,255,255,.92),inset 0 -1px 0 rgba(93,68,37,.12),inset 8px 0 18px rgba(255,255,255,.08); transform:translateY(-1px);
        ...
        html[data-theme='dark'] .simple-nav a:hover,html[data-theme='dark'] .simple-nav a[aria-current] { background:linear-gradient(155deg,rgba(183,214,255,.13),rgba(83,135,204,.055));border-color:rgba(203,225,255,.34);color:var(--ink)!important;box-shadow:0 8px 20px rgba(0,4,16,.13),inset 0 1.5px 0 rgba(223,238,255,.38),inset 0 -1px 0 rgba(0,7,23,.28),inset 8px 0 20px rgba(170,207,255,.055); }
