    ...
    <header data-testid="site-header" className={`surface-accent hairline-b simple-header ${scrollPct > 0 ? 'is-scrolled' : ''}`}>
      ...
      <style>{`
        ...
        html[data-theme='dark'] .simple-header {
          background:radial-gradient(100% 160% at 8% -50%,rgba(224,185,116,.16),transparent 50%),linear-gradient(120deg,rgba(42,33,28,.8),rgba(24,21,19,.68))!important;
          box-shadow:0 20px 54px rgba(0,0,0,.38),inset 0 0 0 1px rgba(216,199,180,.28),inset 2px 3px 0 -2px rgba(255,239,218,.28),inset -2px -2px 0 -2px rgba(188,151,101,.13),inset 0 -7px 3px -6px rgba(0,0,0,.4);
        }
        ...
        html[data-theme='dark'] .simple-header.is-scrolled { box-shadow:0 24px 64px rgba(0,0,0,.48),inset 0 0 0 1px rgba(216,199,180,.28),inset 2px 3px 0 -2px rgba(255,239,218,.28),inset -2px -2px 0 -2px rgba(188,151,101,.13),inset 0 -7px 3px -6px rgba(0,0,0,.4); }
        ...
        html[data-theme='dark'] .simple-nav a:hover,html[data-theme='dark'] .simple-nav a[aria-current] { background:linear-gradient(155deg,rgba(255,239,218,.13),rgba(214,173,104,.06));color:var(--ink)!important;box-shadow:0 8px 20px rgba(0,0,0,.18),inset 0 0 0 1px rgba(216,199,180,.24),inset 0 1.5px 0 rgba(255,239,218,.3),inset 0 -1px 0 rgba(0,0,0,.34),inset 8px 0 20px rgba(214,173,104,.045); }
        ...
        html[data-theme='dark'] .simple-nav a.focus-ring:focus-visible { box-shadow:0 7px 18px rgba(0,0,0,.2),inset 0 0 0 2px rgba(214,173,104,.62),inset 0 1.5px 0 rgba(255,239,218,.28); }
        ...
        html[data-theme='dark'] .simple-nav .header-resume { background:linear-gradient(155deg,rgba(255,239,218,.13),rgba(214,173,104,.07));color:var(--ink)!important;box-shadow:inset 0 0 0 1px rgba(216,199,180,.24),inset 0 1.5px 0 rgba(255,239,218,.28),inset 0 -1px 0 rgba(0,0,0,.28),0 7px 18px rgba(0,0,0,.16)!important; }
        html[data-theme='dark'] .simple-nav .header-resume:hover { background:linear-gradient(155deg,rgba(255,239,218,.18),rgba(214,173,104,.11));color:var(--ink)!important; }
        ...
        @media(max-width:900px){
          ...
          html[data-theme='dark'] .mobile-menu-toggle { background:linear-gradient(150deg,rgba(255,239,218,.12),rgba(214,173,104,.04));box-shadow:inset 0 0 0 1px rgba(216,199,180,.24),inset 0 1.5px 0 rgba(255,239,218,.25); }
          ...
          html[data-theme='dark'] #mobile-nav { background:#181513!important;border-color:rgba(216,199,180,.24);box-shadow:0 26px 80px rgba(0,0,0,.55),inset 0 1px 0 rgba(255,239,218,.16); }
